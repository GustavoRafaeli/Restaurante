...
namespace Restaurante.ConsoleApp.Compartilhado
{
    public abstract class TelaBase
    {
        ...
        public virtual string ApresentarMenu()
        {
            ...
            Console.WriteLine($"Digite 2 para Editar {nomeEntidade}{sufixo}");
            Console.WriteLine($"Digite 3 para Excluir {nomeEntidade}{sufixo}");
        ...
        public virtual void SelecionarOpcao(string opcao)
        {
            switch (opcao)
            {
